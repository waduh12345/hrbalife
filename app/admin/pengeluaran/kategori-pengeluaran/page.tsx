...
} from "@/services/admin/expense-category.service";
import { ExpenseCategory, CreateExpenseCategoryRequest } from "@/types/admin/expense-category";
...
export default function KategoriPengeluaranPage() {
  ...
  const { data, isLoading, refetch } = useGetExpenseCategoryListQuery({
    page: currentPage,
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (isEditMode && editingId) {
        ...
        Swal.fire("Berhasil", "Kategori pengeluaran berhasil diperbarui", "success");
      } else {
        await createCategory(form).unwrap();
        Swal.fire("Berhasil", "Kategori pengeluaran berhasil ditambahkan", "success");
      }
    ...
    <div className="p-6 space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Kelola kategori untuk data pengeluaran</p>
        </div>
